...
//Esta es una expresion para que esté uno de los 3 caracteres que le proponemos
var expresion = /[abc]/;
...
console.log(expresion.test("casa")); //true
console.log(expresion.test("perro")); //false
//que este un rango de letras.Con que este una de ellas ya será true
var expresion = /[d-f]/;
...
//Que esté una de las dos letras entre parentesis, y seguidamente, que este "aca"
