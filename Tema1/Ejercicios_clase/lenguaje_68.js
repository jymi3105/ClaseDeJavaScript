...
var nombre = "Tomas";
//Con esta sintaxis despues de ? antes de : se pone la opcion en el caso de que se cumpla la condicion
nombreExpr.test(nombre) ? console.log("El nombre " + nombre + " esta BIEN escrito.") : console.log("MAL");
...
var telefono = "";
telefonoExpr.test(telefono) ? console.log("BIEN") : console.log("MAL");
