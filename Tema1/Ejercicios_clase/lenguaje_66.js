...
var expresion = /la+/; 
//Tiene que contener exactamente esa cadena
console.log(expresion.test("Hola")); //true
console.log(expresion.test("perro")); //false
...
var expresion = /la*/;
console.log(expresion.test("Hola")); //true
//da falso, porque el asteriscon solo afecta a la a, asi que la "l" debe estar si o si
console.log(expresion.test("perro")); //false
console.log(expresion.test("casa")); //false
console.log(expresion.test("aadflga")); //true
//Aqui el * afecta a todo
var expresion = /(la)*/;
console.log(expresion.test("Hola")); //true
console.log(expresion.test("perro")); //true
console.log(expresion.test("aadflga")); //true
