var miliSegDia = 86400000;

var fechafut = new Date(Date.now());
milisegFech = fechafut.getTime();
t=0;
while (t < 10) {
    if(t==4){
        break;
    }
    milisegFech += miliSegDia;
    fechafut.setTime(milisegFech);
    console.log(fechafut.toLocaleDateString());
    console.log(fechafut.getDate());
    t++;
}
