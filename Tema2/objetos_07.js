...
coche.acelerar();coche.acelerar();coche.acelerar();
console.log("Despues de acelerar otra vez: " + coche.recorrido + " - " + coche.combustible);

//Añadir un método a partir de una función. Es como el ejemplo 3
function repostar1(cantidad) {
    this.combustible += cantidad;
}
//Y aqui le añdimos otra funcion
function robar1(extraccion) {
    this.combustible-=extraccion;
}
...
coche.robar=robar1;
coche.robar(10);
console.log("Despues de robar un poco, nos quedará: " + coche.recorrido + " - " + coche.combustible);