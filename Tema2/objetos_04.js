...
console.log("Lista de propiedades de casa1: " + listaPropiedades);
listaPropiedades.forEach(x => console.log(" --> " + casa1[x]));

var listaPropiedades = Object.keys(casa2);
console.log("PROPIEDADES DEL OBJETO casa2");
console.log("Lista de propiedades de casa2: " + listaPropiedades);
listaPropiedades.forEach(x => console.log(" --> " + casa2[x]));
...
console.log("La lista de propiedades del propietario: " + listaPropiedades);
